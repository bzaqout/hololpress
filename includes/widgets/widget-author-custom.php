<?php
add_action( 'widgets_init', 'holol_author_custom_widget' );
function holol_author_custom_widget() {
	register_widget( 'holol_author_custom' );
}
class holol_author_custom extends WP_Widget {

	function holol_author_custom() {
		$widget_ops 	= array( 'classname' => 'author-custom'  );
		$control_ops 	= array( 'width' => 250, 'height' => 350, 'id_base' => 'author-custom-widget' );
		parent::__construct( 'author-custom-widget', __( "محتوى كاتب مخصص" , 'tie' ) , $widget_ops, $control_ops );
	}
