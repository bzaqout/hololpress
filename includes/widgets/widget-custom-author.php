<?php
add_action( 'widgets_init', 'holol_Author_Bio_widget' );
function holol_Author_Bio_widget() {
	register_widget( 'holol_Author_Bio' );
}
class holol_Author_Bio extends WP_Widget {

	function holol_Author_Bio() {
		$widget_ops 	= array( 'classname' => 'Author-Bio' );
		$control_ops 	= array( 'width' => 250, 'height' => 350, 'id_base' => 'author-bio-widget' );
		parent::__construct( 'author-bio-widget', __( 'سيرة كاتب مخصص' , 'tie' ) , $widget_ops, $control_ops );
	}
