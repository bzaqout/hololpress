...
class holol_slider extends WP_Widget {
	...
	function holol_slider() {
		...
		parent::__construct( 'tie-slider-widget',__( 'سلايدر' , 'tie'), $widget_ops, $control_ops );
	}
	...
	<?php endif; ?>
	<?php else :
		$custom_slider_args 	= array( 'post_type' => 'holol_slider', 'p' => $custom_slider, 'no_found_rows' => 1  ) ;
	...
	<div class="flexslider" id="<?php echo $args['widget_id']; ?>">
		...
		<?php while ( $custom_slider_query->have_posts() ) : $custom_slider_query->the_post();
			...
			<li>
				...
				<img src="<?php echo holol_slider_img_src( $slide['id'] , 'tie-large' ) ?>" alt="" />
	...
	function form( $instance ) {
		...
		$sliders = array();
		$custom_slider = new WP_Query( array( 'post_type' => 'holol_slider', 'posts_per_page' => -1, 'no_found_rows' => 1  ) );
