...
add_action( 'widgets_init', 'holol_flickr_photos_widget' );
function holol_flickr_photos_widget() {
	register_widget( 'holol_flickr_photos' );
}
class holol_flickr_photos extends WP_Widget {

	function holol_flickr_photos() {
		$widget_ops 	= array( 'classname' => 'flickr-widget' );
		$control_ops 	= array( 'width' => 250, 'height' => 350, 'id_base' => 'flickr_photos-widget' );
		parent::__construct( 'flickr_photos-widget', __( 'فلكر' , 'tie') , $widget_ops, $control_ops );
	}
