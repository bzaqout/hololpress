			...
			<div id="content" class="clearfix row">
				...
				<div id="main" class="col-sm-8 clearfix" role="main">
					...
					<article id="post-not-found">
					    	<h1><?php _e("No Posts Yet", "divvat"); ?></h1>
					    <section class="post_content">
					    	<p><?php _e("Sorry, What you were looking for is not here.", "divvat"); ?></p>
					    </section>
					</article>
				...
				<div id="sidebar1" class="col col-lg-4 fluid-sidebar sidebar" role="complementary">
					...
					<div class="well">
						...
						<h3><?php _e("Image metadata","divvat"); ?></h3>
					...
					// Start to display EXIF and IPTC data of digital photograph
					       if ( $imgmeta['image_meta']['created_timestamp'] ) { 
					           echo __("Date Taken","divvat") . ": " . date("d-M-Y H:i:s", $imgmeta['image_meta']['created_timestamp'])."<br />"; }
					       if ( $imgmeta['image_meta']['copyright'] ) { 
					           echo __("Copyright","divvat") . ": " . $imgmeta['image_meta']['copyright']."<br />"; }
					       if ( $imgmeta['image_meta']['credit'] ) { 
					           echo __("Credit","divvat") . ": " . $imgmeta['image_meta']['credit']."<br />"; }
					       if ( $imgmeta['image_meta']['title'] ) { 
					           echo __("Title","divvat") . ": " . $imgmeta['image_meta']['title']."<br />"; }
					       if ( $imgmeta['image_meta']['caption'] ) { 
					           echo __("Caption","divvat") . ": " . $imgmeta['image_meta']['caption']."<br />"; }
					       if ( $imgmeta['image_meta']['camera'] ) { 
					           echo __("Camera","divvat") . ": " . $imgmeta['image_meta']['camera']."<br />"; }
					       if ( $imgmeta['image_meta']['focal_length'] ) { 
					           echo __("Focal Length","divvat") . ": " . $imgmeta['image_meta']['focal_length']."mm<br />"; }
					       if ( $imgmeta['image_meta']['aperture'] ) { 
					           echo __("Aperture","divvat") . ": f/" . $imgmeta['image_meta']['aperture']."<br />"; }
					       if ( $imgmeta['image_meta']['iso'] ) { 
					           echo __("ISO","divvat") . ": " . $imgmeta['image_meta']['iso']."<br />"; }
					       if ( $pshutter ) { 
					           echo __("Shutter Speed","divvat") . ": " . $pshutter . "<br />"; }
					   ?>
					</div>
